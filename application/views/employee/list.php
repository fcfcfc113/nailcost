        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="emptable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    $hidden_btn = "";
                    $role != 5 ? $hidden_btn = "disabled" : $hidden_btn ="";
                    foreach ($employee as $row) {
                        ...
                        if ($status == 1) {
                            ...
                            $status = 'Active';
                            $btn = "<a href='#' data-object-id='" . $aid . "' class='btn btn-amber btn-xs delete-object ".$hidden_btn."' title='Disable'><i class='fa fa-chain-broken'></i> " . $this->lang->line('Disable') . "</a>";
                        }
                    ...
                    <td>$role</td>                 
                    <td>$status</td>
                    <td><a href='" . base_url("employee/view?id=$aid") . "' class='btn btn-success btn-xs'><i class='fa fa-eye'></i> " . $this->lang->line('View') . "</a>&nbsp;&nbsp;$btn&nbsp;&nbsp;<a href='#pop_model' data-toggle='modal' data-remote='false' data-object-id='" . $aid . "' class='btn btn-danger btn-xs delemp ".$hidden_btn."' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                        $i++;
                    }
                    ?>
                    </tbody>
