...
<div class="invoice-box">
    ...
    echo '<br><div class="sign">' . $this->lang->line('Authorized person') . '</div><div class="sign1"><img src="' . base_url('userfiles/employee_sign/' . $employee['sign']) . '" width="160" height="90" border="0" alt=""></div><div class="sign2">(' . $employee['name'] . ')</div><div class="sign3">' . user_role($employee['roleid']) . '</div><br><br><br><div class="signr">_____________________________<br>' . $this->lang->line('Received by') . ' &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div><hr><strong>' . $this->lang->line('Terms') . ':</strong><div class="terms">' . $invoice['notes'] . '';
